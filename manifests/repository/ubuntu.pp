...
# This is the ugliest approach ever, key_content only accepts a string as an
# option :(
# We have to use *key_content* in the first place because *key_source* does not
# allow to use credentials within an https URI, even though it was fixed in
# theory: https://tickets.puppetlabs.com/browse/MODULES-1119
#
